...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: "/components/MesNotifications",
    title: "Notifications",
    type: "link",
    icontype: "ni-shop text-primary"
  },

  {
    ...
    isCollapsed: true,
    children: [
      { path: "users", title: "Utilisateurs", type: "link" },
      { path: "poles", title: "Poles", type: "link" },
      { path: "divisions", title: "Divisions", type: "link" },
      { path: "affaires", title: "Affaires", type: "link" },
      { path: "soustraitants", title: "Soustraitants", type: "link" },
      { path: "contratSoustraintance", title: "contrat Sous traintance", type: "link" },
  ...
  },
  {
    ...
    isCollapsed: true,
    children: [
      { path: "MesContrat", title: "Mes Contrats", type: "link" },
      { path: "contrat", title: "Recherche Contrat", type: "link" },
