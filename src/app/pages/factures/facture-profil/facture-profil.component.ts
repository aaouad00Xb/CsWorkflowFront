...
@Component({
  selector: 'app-facture-profil',
  templateUrl: './facture-profil.component.html',
  styleUrls: ['./facture-profil.component.scss']
})
export class FactureProfilComponent implements OnInit{
    ...
    //   )  }
      ...
      this.service.getContratById(this.paramValue).subscribe(
        res=>{
          ...
          this.getEntryDate(this.selectedSoustraitance.factureID,this.selectedSoustraitance.currentStep.stepID);
          this.getAllEntryDate(this.selectedSoustraitance.factureID);
  ...
  async validate(){
    ...
    if(this.selectedSoustraitance?.currentStep?.previousStep.stepID == this.nextstepID){
      this.service.transitionContratToStep(this.selectedSoustraitance.factureID,this.selectedSoustraitance?.currentStep?.previousStep?.stepID,this.commentaire).subscribe(res=>{
        console.log(res)
      },err=>console.log(err))
      return;
    }
    ...
    if(!valid){
      ...
      this.service.transitionContratToStep(this.selectedSoustraitance.factureID,this.selectedSoustraitance?.currentStep?.nextStep?.stepID,this.commentaire).subscribe(res=>{
        console.log(res)
      },err=>console.log(err))
